...
data <- read.csv("C:/Users/fccom/Documents/R Data story telling/FMFM2019_seminar.csv")

frame <- data[ , c("Enterprise.Flag", "Purpose.of.Loan", "Borrower.Gender", "Co.Borrower.Gender", "Age.of.Borrower", "Age.of.Co.Borrower", "Rate.Spread", "Interest.Rate.at.Origination", "Automated.Underwriting.System..AUS.", "Credit.Score.Model...Borrower", "Debt.to.Income..DTI..Ratio", "Property.Value", "First.Time.Home.Buyer", "Acquisition.Unpaid.Principal.Balance..UPB.", "Federal.Guarantee", "Borrower.Income.Ratio", "Borrower.Race1", "High.Opportunity.Area","Borrower?..s..or.Borrowers?....Annual.Income","US.Postal.State.Code", "Loan.to.Value.Ratio..LTV.")] 
...
frame$US.Postal.State.Code[frame$US.Postal.State.Code == 00] <- NA
